...
public class Actividad_pruebas {
    public static void main(String[] args) {
        ...
        try {
            ...
            con2 = DriverManager.getConnection("jdbc:sqlite:bas.db");
            ...
            if (con2 != null) System.out.println("Conexión establecida!\n");

            // 3. Obtener los metadatos de la DB +Import
            DatabaseMetaData mt = con2.getMetaData();
